...
using UnityEditor;
using UnityEngine;
namespace Firearms.Actions.Editor
{

    [CustomEditor(typeof(FirearmData))]
    public class FirearmDataEditor : UnityEditor.Editor
    {
        ...
        void OnEnable()
        {
            PrimaryFireActionListGUI = SetupReorderableList((target as FirearmData).onPrimaryFireActions, "OnPrimaryFire");
            SecondaryFireActionListGUI = SetupReorderableList((target as FirearmData).onSecondaryFireActions, "OnSecondaryFire");
        }
