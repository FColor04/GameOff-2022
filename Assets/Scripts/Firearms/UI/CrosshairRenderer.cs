...
namespace Firearms.UI
{
    public class CrosshairRenderer : Graphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            {
                case CrosshairData.InsideShape.Dot:
                    ...
                    vertexCounter += 4;
                    break;
                case CrosshairData.InsideShape.Cross:
                    //Top part
                    ...
                    vertexCounter += 4;
                    break;
                case CrosshairData.InsideShape.NGon:
                    //Inside verts
                    ...
                    break;
                case CrosshairData.InsideShape.Nothing:
                    break;
            }
            ...
            {
                case CrosshairData.OutsideShape.Lines:
        ...
        private void Update()
        {
            switch (CurrentCrosshair.outsideBehaviour)
            {
                ...
                case CrosshairData.CrosshairBehaviour.Offset:
                    ...
                    SetVerticesDirty();
                    break;
                case CrosshairData.CrosshairBehaviour.InverseOffset:
                    ...
                    SetVerticesDirty();
                    break;
                case CrosshairData.CrosshairBehaviour.Spin:
